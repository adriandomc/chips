...
> **EJECUTADO**. R1–R4 mergeados a `main`. Este documento queda como
> registro histórico de la propuesta y el razonamiento detrás del refactor.
> El estado actual de la deuda técnica vive ahora en `CLAUDE.md` § 7.
